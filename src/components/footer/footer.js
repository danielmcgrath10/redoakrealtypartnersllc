    ...
    return(
        <div id={'footer'}>
            ...
            <div className={'footer-section'}>
                ...
                <span className={'footer-text-attr'}>Photo by <a href="https://unsplash.com/@clemono?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText">Clem Onojeghuo</a> on <a href="https://unsplash.com/s/photos/relax?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText">Unsplash</a></span>
                <span className={'footer-text-attr'}>Photo by <a href="https://unsplash.com/@knobelman?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText">Yaniv Knobel</a> on <a href="https://unsplash.com/s/photos/alarm?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText">Unsplash</a></span>
            </div>
        </div>
    )
}