...
export default function ContactPopover(props){
    ...
    const [successfulSubmit, setSuccessfulSubmitted] = useState(false);
    ...
    const submitForm = async (e) => {
        ...
        // formData.append(GOOGLE_FORM_FIRST, form.inputFirstName.value);
        // formData.append(GOOGLE_FORM_LAST, form.inputLastName.value);
        // formData.append(GOOGLE_FORM_EMAIL, form.inputEmail.value);
        // formData.append(GOOGLE_FORM_ADDRESS, form.inputAddress.value);
        // formData.append(GOOGLE_FORM_CITY, form.inputCity.value);
        // formData.append(GOOGLE_FORM_STATE, form.inputState.value);
        // formData.append(GOOGLE_FORM_ZIP, form.inputZip.value);
        // formData.append(GOOGLE_FORM_TELEPHONE, phoneNum);
        // formData.append("submit", "Submit");
        // await fetch('https://docs.google.com/forms/u/1/d/e/1FAIpQLSd5GEU9e2Jj_fbkfld1l1tAirl_zlk4MwpLStX9AYbL8zslWg/formResponse?', {
        //     method: "POST",
        //     mode: "no-cors",
        //     body: formData
        // })
