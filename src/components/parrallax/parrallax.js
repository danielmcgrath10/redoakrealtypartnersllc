  ...
  return (
    <div id={"parrallax-section"}>
      <div className={"parrallax-section-section"}>
        ...
        <img id={"fallingmoney1"} alt={"Fast Cash"} src={Money} />
        <img id={"fallingmoney2"} alt={"Fast Cash"} src={Money} />
      </div>
      <div id={"help-section"} className={"parrallax-section-section"}>
        <div id={"help-boxes"}>
          ...
          <div className={"message-box"}>
            <img
              src={Phone}
              alt={"Leave Your Number"}
              className={"message-box-img"}
            />
            <span className={"message-box-text"}>We Call You</span>
          </div>
          <div className={"message-box"}>
            <img src={Money} alt={"Fast Cash"} className={"message-box-img"} />
            <span className={"message-box-text"}>
      ...
      <div className={"parrallax-section-section"}>
        <span id={"header-text-bottom"}>
          Your Money Is Waiting.
          <br /> Contact Us Today
        </span>
        <img id={"fallingmoney5"} alt={"Fast Cash"} src={Money} />
        <img id={"fallingmoney6"} alt={"Fast Cash"} src={Money} />
        ...
        <img id={"money"} alt={"Fast Cash"} src={Money} />
        <img id={"money1"} alt={"Fast Cash"} src={Money} />
        <img id={"money2"} alt={"Fast Cash"} src={Money} />
